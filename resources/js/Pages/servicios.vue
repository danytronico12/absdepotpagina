<template>
    ...
    <div
        ...
        <img
            ...
            src="/storage/image/pexel22.jpg"
            alt="" />
        <div class="absolute text-center  inset-x-[15%] inset-y-[35%]">
            <h5 class="mb-2 text-4xl font-medium leading-tight text-black">
                Card title
            </h5>
    ...
    <div class="p-12"> <div
        ...
        <img
            class="h-96 w-1/2 rounded-t-lg object-cover md:h-auto md:!rounded-none md:!rounded-l-lg"
