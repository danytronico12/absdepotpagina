<template>
    <!-- Footer container -->
    <footer
        class="bg-neutral-800 text-center text-neutral-600  text-white lg:text-left">
        <div
        ...
        <div class="px-6 py-10 text-center md:text-left bg-blue-900 text-white">
            <div class="grid-1 grid  md:grid-cols-2 lg:grid-cols-3">
